...
$router->add("/admin/task/(\d+)/add", ['GET', 'POST'], 'App\Controller\TaskController', 'add', 'add_task');
...
$router->add("/admin/type/(\d+)/add", ['GET', 'POST'], 'App\Controller\TypeController', 'add', 'add_type');
...
$router->add("/admin/tag/(\d+)/add", ['GET', 'POST'], 'App\Controller\TagController', 'add', 'add_tag');
...
$router->add("/admin/project/(\d+)/add", ['GET', 'POST'], 'App\Controller\ProjectController', 'add', 'add_project');
